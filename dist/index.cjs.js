...
var ansiStyles = require('ansi-colors');
...
var ansiStyles__default = /*#__PURE__*/_interopDefaultLegacy(ansiStyles);
...
function toDate(value) {
  ...
  if (isString(value) || isNumber(value)) value = new Date(value);
  if (isDate(value)) return value;
  return def;
}
/**
...
var appendFileSync = fsExtra__default['default'].appendFileSync,
    ensureDirSync = fsExtra__default['default'].ensureDirSync,
    existsSync = fsExtra__default['default'].existsSync,
    readFileSync = fsExtra__default['default'].readFileSync,
    readJSONSync = fsExtra__default['default'].readJSONSync;
var PKG = readPkg();
...
function hasColorSupport() {
  return !!supportsColor__default['default'];
}
function readPkg(path$1) {
  path$1 = path$1 || path.join(process.cwd(), 'package.json');
  return readJSONSync(path$1, {
    "throws": false
  }) || {};
}
/**
...
function getHistoryPath(appName, rootDir) {
  rootDir = !rootDir ? path.join(os.homedir(), ".".concat(APP_NAME)) : rootDir;
  ensureDirSync(rootDir);
  return path.join(rootDir, (appName || 'default') + '.txt');
}
/**
...
function colorize(str) {
  if (!supportsColor__default['default'] || !str) return str;
  ...
  return styles.reduce(function (a, c) {
    if (typeof ansiStyles__default['default'][c] !== 'undefined') a = ansiStyles__default['default'][c](a);
    return a;
  }, str);
}
/**
...
function normalizeOptions(options) {
  ...
  var ms = new MuteStream__default['default']();
...
var Optio = /*#__PURE__*/function () {
  function Optio(events, options) {
    ...
    this.rl = readline__default['default'].createInterface(options);
  ...
  _createClass(Optio, [{
        ...
        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                line = line.trim();
                args = split__default['default'](line, {
                  separator: ' ',
                  quotes: ['"', "'"]
                });
                name = args.shift();
    ...
    key: "readline",
    get: function get() {
      return readline__default['default'];
    }
    /**
    ...
    key: "figures",
    get: function get() {
      return figures__default['default'];
    }
  }, {
    key: "plugins",
    get: function get() {
    ...
    value: function cursorTo(x, y, cb) {
      return readline__default['default'].cursorTo(this.stdout, x, y, cb);
    }
    /**
    ...
    value: function cursorMove(dx, dy, cb) {
      return readline__default['default'].moveCursor(this.stdout, dx, dy, cb);
    }
    /**
    ...
    value: function clearDown() {
      return readline__default['default'].clearScreenDown(this.stdout);
    }
    /**
    ...
    value: function clearLine() {
      ...
      return readline__default['default'].clearLine(this.stdout, direction, function () {
        return onClear;
      });
    }
    /**
    ...
    value: function formatError(err) {
      var prefix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : figures__default['default'].pointer;
